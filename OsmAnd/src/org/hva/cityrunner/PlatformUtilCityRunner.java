 ...
 * 		Logger.getLogger("org.hva.cityrunner").setLevel(Level.ALL);
 ...
 *  
 */
public class PlatformUtilCityRunner {
	public static String TAG = "org.hva.cityrunner"; //$NON-NLS-1$
...
//			return android.util.Log.isLoggable(TAG, android.util.Log.DEBUG);
	...
	public static org.hva.cityrunner.Collator primaryCollator(){
		final Collator instance = Collator.getInstance();
		instance.setStrength(Collator.PRIMARY);
		return new org.hva.cityrunner.Collator() {
