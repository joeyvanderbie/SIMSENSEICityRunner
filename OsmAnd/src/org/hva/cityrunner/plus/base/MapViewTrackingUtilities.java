...
public class MapViewTrackingUtilities implements OsmAndLocationListener, IMapLocationListener, OsmAndCompassListener {
	...
	private void registerUnregisterSensor(org.hva.cityrunner.Location location, boolean overruleRegister) {
		...
		if (mapView != null) {
			...
			if (!isMapLinkedToLocation()) {
				...
				if (locationProvider.getLastKnownLocation() != null) {
					org.hva.cityrunner.Location lastKnownLocation = locationProvider.getLastKnownLocation();
