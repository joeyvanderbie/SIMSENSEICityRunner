...
public class ExternalServiceAPIImpl implements ExternalServiceAPI {
	...
	private static final Log log = PlatformUtilCityRunner.getLog(ExternalServiceAPIImpl.class);
	...
	public AudioFocusHelper getAudioFocuseHelper() {
		if (android.os.Build.VERSION.SDK_INT >= 8) {
			try {
				return (AudioFocusHelper) Class.forName("org.hva.cityrunner.plus.api.AudioFocusHelperImpl").newInstance();
			} catch (Exception e) {
