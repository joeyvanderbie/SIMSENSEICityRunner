 ...
 * @author genly
 */
public class AudioFocusHelperImpl implements AudioManager.OnAudioFocusChangeListener, org.hva.cityrunner.plus.api.ExternalServiceAPI.AudioFocusHelper {
	private static final Log log = PlatformUtilCityRunner.getLog(AudioFocusHelperImpl.class);
