...
import org.hva.cityrunner.plus.api.SQLiteAPI.SQLiteConnection;
import org.hva.cityrunner.plus.api.SQLiteAPI.SQLiteCursor;
...
public class SQLiteTileSource implements ITileSource {
	...
	private static final Log log = PlatformUtilCityRunner.getLog(SQLiteTileSource.class); 
	...
	public synchronized void insertImage(int x, int y, int zoom, File fileToSave) throws IOException {
		...
		org.hva.cityrunner.plus.api.SQLiteAPI.SQLiteStatement statement = db.compileStatement("INSERT INTO tiles VALUES(?, ?, ?, ?, ?)"); //$NON-NLS-1$
