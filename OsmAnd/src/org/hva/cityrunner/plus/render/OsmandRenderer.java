...
import org.hva.cityrunner.plus.render.TextRenderer.TextDrawInfo;
...
public class OsmandRenderer {
	private static final Log log = PlatformUtilCityRunner.getLog(OsmandRenderer.class);
	...
	/* package */static class RenderingContext extends org.hva.cityrunner.RenderingContext {
