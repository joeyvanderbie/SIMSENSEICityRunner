...
import org.hva.cityrunner.util.SunriseSunset;
...
import org.hva.cityrunner.plus.OsmandSettings.DayNightMode;
...
public class DayNightHelper implements SensorEventListener {
	private static final Log log = PlatformUtilCityRunner.getLog(DayNightHelper.class);
