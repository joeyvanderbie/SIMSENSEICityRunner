...
import org.hva.cityrunner.plus.activities.FavouritesListActivity;
import org.hva.cityrunner.plus.activities.FavouritesListFragment;
import org.hva.cityrunner.plus.activities.NavigatePointFragment;
...
public class SearchActivity extends SherlockFragmentActivity implements OsmAndLocationListener {
	...
	public static final String SEARCH_LAT = "org.hva.cityrunner.search_lat"; //$NON-NLS-1$
	public static final String SEARCH_LON = "org.hva.cityrunner.search_lon"; //$NON-NLS-1$
...
//		getSupportActionBar().setTitle(R.string.select_search_position);
		...
		Log.i("org.hva.cityrunner", "Start on create " + (System.currentTimeMillis() - t ));
			...
			public boolean onNavigationItemSelected(int position, long itemId) {
				if (position != 0) {
					if (position == POSITION_CURRENT_LOCATION) {
						org.hva.cityrunner.Location loc = getLocationProvider().getLastKnownLocation();
