...
import org.hva.cityrunner.binary.BinaryIndexPart;
...
import org.hva.cityrunner.map.TileSourceManager;
...
import org.hva.cityrunner.plus.GPXUtilities.Track;
import org.hva.cityrunner.plus.GPXUtilities.TrkSegment;
...
import org.hva.cityrunner.plus.voice.MediaCommandPlayerImpl;
import org.hva.cityrunner.plus.voice.TTSCommandPlayerImpl;
				...
				for(TrkSegment segment : subtrack.segments){
					...
					for (int j = 0; j < segment.points.size(); j++) {
						...
						if (j > 0) {
							...
							org.hva.cityrunner.Location.distanceBetween(prev.lat, prev.lon, point.lat, point.lon, calculations);
