...
import org.hva.cityrunner.plus.api.ExternalServiceAPI.AudioFocusHelper;
...
public abstract class AbstractPrologCommandPlayer implements CommandPlayer {
	...
	private static final Log log = PlatformUtilCityRunner.getLog(AbstractPrologCommandPlayer.class);
