...
import org.hva.cityrunner.map.IMapLocationListener;
...
import org.hva.cityrunner.access.AccessibilityActionsProvider;
import org.hva.cityrunner.access.AccessibleToast;
import org.hva.cityrunner.access.MapExplorer;
...
import org.hva.cityrunner.plus.views.MultiTouchSupport.MultiTouchZoomListener;
...
public class OsmandMapTileView extends SurfaceView implements IMapDownloaderCallback, Callback {
	...
	protected static final Log log = PlatformUtilCityRunner.getLog(OsmandMapTileView.class);
	/**MapTree
