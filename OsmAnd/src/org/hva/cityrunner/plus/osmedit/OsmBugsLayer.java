...
import org.hva.cityrunner.plus.osmedit.OsmPoint.Action;
import org.hva.cityrunner.plus.views.OsmandMapLayer;
import org.hva.cityrunner.plus.views.OsmandMapTileView;
import org.hva.cityrunner.plus.views.ContextMenuLayer.IContextMenuProvider;
...
public class OsmBugsLayer extends OsmandMapLayer implements IContextMenuProvider, DialogProvider {
	...
	private static final Log log = PlatformUtilCityRunner.getLog(OsmBugsLayer.class); 
