...
import org.hva.cityrunner.osm.edit.Entity.EntityType;
import org.hva.cityrunner.osm.edit.EntityInfo;
import org.hva.cityrunner.osm.edit.Node;
import org.hva.cityrunner.osm.io.Base64;
import org.hva.cityrunner.osm.io.NetworkUtils;
import org.hva.cityrunner.osm.io.OsmBaseStorage;
...
//	private final static String SITE_API = "http://api06.dev.openstreetmap.org/";
	...
	public final static Log log = PlatformUtilCityRunner.getLog(OpenstreetmapRemoteUtil.class);
