...
import org.hva.cityrunner.binary.OsmandOdb.OsmAndPoiNameIndex.OsmAndPoiNameIndexData;
...
public class BinaryMapPoiReaderAdapter {
	private static final Log LOG = PlatformUtilCityRunner.getLog(BinaryMapPoiReaderAdapter.class);
