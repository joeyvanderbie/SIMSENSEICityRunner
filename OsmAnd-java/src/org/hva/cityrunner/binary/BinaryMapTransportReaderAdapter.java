...
public class BinaryMapTransportReaderAdapter {
	...
	public org.hva.cityrunner.data.TransportRoute getTransportRoute(int filePointer, TIntObjectHashMap<String> stringTable,
		...
		org.hva.cityrunner.data.TransportRoute dataObject = new org.hva.cityrunner.data.TransportRoute();
		boolean end = false;
		long rid = 0;
		int rx = 0;
		int ry = 0;
	...
	protected void initializeNames(boolean onlyDescription, org.hva.cityrunner.data.TransportRoute dataObject,
